...
description: Run a comprehensive accessibility audit (WCAG 2.1 Level AA) on the web project using axe-core (runtime browser scanning) and eslint-plugin-jsx-a11y (static analysis), in runtime / static / full modes. Use when the user says "run accessibility scan", "a11y audit", "check accessibility", "WCAG compliance", or invokes /accessibility or /a11y. Source: github.com/airowe/claude-a11y-skill.
---
