...
vi.mock('@/components/Workspace/DashboardArea/Dashboard/DashboardSurface/TabBody', () => ({
...
vi.mock('@/components/Workspace/Sidebar/Sidebar', () => ({ Sidebar: () => <div data-testid="sidebar" /> }));
vi.mock('@/components/Workspace/DashboardArea/Console/Console', () => ({ Console: () => <div data-testid="console" /> }));
