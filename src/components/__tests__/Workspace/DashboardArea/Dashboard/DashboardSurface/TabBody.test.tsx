...
vi.mock('@/components/Workspace/DashboardArea/Dashboard/ChatTab/ChatTab', () => ({ ChatTab: () => <div data-testid="chat-tab" /> }));
vi.mock('@/components/Workspace/DashboardArea/Dashboard/SessionViewer/SessionViewer', () => ({ SessionViewer: () => <div data-testid="session-viewer" /> }));
vi.mock('@/components/Workspace/DashboardArea/Dashboard/SkillDetail/SkillDetail', () => ({ SkillDetail: () => <div data-testid="skill-detail" /> }));
