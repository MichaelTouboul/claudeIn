...
vi.mock('@/components/AgentChat/AgentChatHeader/AgentChatHeader', () => ({ AgentChatHeader: () => <div /> }));
vi.mock('@/components/AgentChat/AgentChatMessages/AgentChatMessages', () => ({ AgentChatMessages: () => <div /> }));
