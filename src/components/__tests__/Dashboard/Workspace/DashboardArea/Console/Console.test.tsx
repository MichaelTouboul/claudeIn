...
import { Console } from '@/components/Dashboard/Workspace/DashboardArea/Console/Console';
...
vi.mock('@/components/Dashboard/Workspace/DashboardArea/Console/TerminalView/TerminalView', () => ({
  TerminalView: () => <div data-testid="terminal-view" />,
}));
vi.mock('@/components/Dashboard/EventConsole/EventConsole', () => ({
