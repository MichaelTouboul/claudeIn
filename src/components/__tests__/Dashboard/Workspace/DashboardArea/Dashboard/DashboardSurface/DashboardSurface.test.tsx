...
import { DashboardSurface } from '@/components/Dashboard/Workspace/DashboardArea/Dashboard/DashboardSurface/DashboardSurface';
...
vi.mock('@/components/Dashboard/Workspace/DashboardArea/Dashboard/DashboardSurface/TabBody', () => ({
