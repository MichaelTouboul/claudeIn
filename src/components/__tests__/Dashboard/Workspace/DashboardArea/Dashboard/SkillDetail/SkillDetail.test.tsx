...
import { SkillDetail } from '@/components/Dashboard/Workspace/DashboardArea/Dashboard/SkillDetail/SkillDetail';
import type { SkillFile } from '@/hooks/useProjects';

// Isolate the fetching wrapper: stub the content child and the api.
vi.mock('@/components/Dashboard/Workspace/DashboardArea/Dashboard/SkillDetail/SkillDetailContent', () => ({
