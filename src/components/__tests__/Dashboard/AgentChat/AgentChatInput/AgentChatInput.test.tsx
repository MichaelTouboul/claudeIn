...
import { AgentChatInput } from '@/components/Dashboard/AgentChat/AgentChatInput/AgentChatInput';
...
vi.mock('@/components/Dashboard/AgentChat/AgentChatInput/AttachMenu/AttachMenu', () => ({
  AttachMenu: () => <div />,
}));
vi.mock('@/components/Dashboard/AgentChat/AgentChatInput/AgentTabs/AgentTabs', () => ({
  AgentTabs: () => <div />,
}));
