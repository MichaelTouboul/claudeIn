...
export function registerSpawnHandlers(): void {
  ...
  ipcMain.handle("spawn:start",(_e, opts: { agent_name?: string; mission: string; cwd?: string; resume_session_id?: string; model?: string; permission_mode?: string; think?: boolean }) =>
    spawnService.spawnAgent(opts.agent_name || "_main", opts.mission, opts.cwd, opts.resume_session_id, opts.model, opts.permission_mode, opts.think));
